...
Instead of resolving a Sugar Shack:
	...
	say "     [bold type]Will you take the sugar glider's offer?[roman type]";
	LineBreak;
	say "     ([link]Y[as]y[end link]) - Indulge in the sugary treat.";
	say "     ([link]N[as]n[end link]) - This seems sketchy...";
	if player consents:
		LineBreak;
		...
		if "Junk Food Junky" is listed in feats of player, SanLoss 35;
		else:
			SanLoss 25;
		if humanity of player < 10:
			...
			if player consents:
				...
				if "Junk Food Junky" is listed in feats of player, PlayerEat 6;
				else:
					PlayerEat 3;
	else:
		LineBreak;
